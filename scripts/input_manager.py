...
def submit() -> bool:
    ...
    """
    return any(code in keys_pressed for code in (K_RETURN, K_SPACE))
...
def up_pressed() -> bool:
    ...
    """
    return any(code in keys_pressed for code in (K_UP, K_w, K_z))
...
def down_pressed() -> bool:
    ...
    """
    return any(code in keys_pressed for code in (K_DOWN, K_s))
...
def crouch() -> bool:
    ...
    """
    return any(keys_down[code] for code in (K_LCTRL, K_RCTRL, K_LSHIFT, K_RSHIFT))
...
def jump() -> bool:
    ...
    """
    return K_SPACE in keys_pressed
