...
ornements: tuple[Surface, ...] = tuple(load_image("props", "ornements", f"ornement{i}") for i in range(17))
...
clocks: tuple[Surface, ...] = tuple(load_image("props", "clocks", f"clock{i}") for i in range(4))
wooden_chair_back: Surface = load_image("props", "wooden_chair", "back")
wooden_chair_seat: Surface = load_image("props", "wooden_chair", "seat")
wooden_chair_front: Surface = load_image("props", "wooden_chair", "front")
bookshelves: tuple[Surface, ...] = tuple(load_image("props", "bookshelves", f"book{i}") for i in range(8))
george: Surface = load_image("props", "george")
closet_front: Surface = load_image("props", "closet", "front")
closet_side: Surface = load_image("props", "closet", "side")
grandpa_clock_front: Surface = load_image("props", "grandpaclock", "front")
grandpa_clock_side: Surface = load_image("props", "grandpaclock", "side")
